...
let PuerTs_MCS_Debug = puer.loadType("PuerTsPlugin.PuerTS_MCS.Main");

if (UnityEngine_Debug) {
    const console_org = global.console;
    var console = Object.assign({}, console_org)
    ...
    console.log = function() {
        ...
        if (PuerTs_MCS_Debug) {
            PuerTs_MCS_Debug.Log(toString(arguments));
        } else {
    ...
    console.info = function() {
        ...
        if (PuerTs_MCS_Debug) {
            PuerTs_MCS_Debug.LogInfo(toString(arguments));
        } else {
            UnityEngine_Debug.Log(toString(arguments));
        }
    }
    ...
    console.warn = function() {
        ...
        if (PuerTs_MCS_Debug) {
            PuerTs_MCS_Debug.LogWarn(toString(arguments));
        } else {
            UnityEngine_Debug.Log(toString(arguments));
        }
    }
    ...
    console.error = function() {
        ...
        if (PuerTs_MCS_Debug) {
            PuerTs_MCS_Debug.LogError(toString(arguments));
        } else {
            UnityEngine_Debug.Log(toString(arguments));
        }
    }
    ...
    console.trace = function() {
        ...
        if (PuerTs_MCS_Debug) {
            PuerTs_MCS_Debug.LoggerError(toString(arguments) + "\n" + getStack(new Error()) + "\n");
        } else {
            UnityEngine_Debug.Log(toString(arguments) + "\n" + getStack(new Error()) + "\n");
        }
    }
