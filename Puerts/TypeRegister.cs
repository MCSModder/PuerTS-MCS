...
using System.Linq;
using PuerTsPlugin.PuerTS_MCS.Puerts.Native;
using PuerTsPlugin.PuerTS_MCS.Puerts.Translator;
using PuerTsPlugin.PuerTS_MCS.Puerts.Wrapper;

namespace PuerTsPlugin.PuerTS_MCS.Puerts
{
    internal class TypeRegister
    {
        ...
        {
            arrayTypeId = PuertsDLL.RegisterClass(jsEnv.isolate, GetTypeId(isolate, typeof(Array)), "__puerts.Array", null, null, jsEnv.Idx);
